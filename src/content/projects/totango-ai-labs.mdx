...
- **Shipped — Account Summary**: a one-click synthesis of every integrated data source for a customer account
- **Shipped — Data Integration Filter Builder**: a plain-English to query translator for Salesforce and MS Dynamics setup
- **Shipped — Content Creator**: an embedded AI writing assistant for touchpoints, tasks, and campaign templates
- **Shelved — Totango Copilot**: a conversational interface for goal-driven actions inside Totango
- **Shelved — Segment Creator**: plain-English to Totango query, the capability Copilot depended on
