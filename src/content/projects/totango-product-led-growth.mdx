...
<MetricGrid metrics={[
  { value: "−15% → +50%", valueSize: "text-2xl", label: "SMB segment margin", detail: "From net loss to net profit" },
  { value: "2×", valueSize: "text-2xl", label: "SMB revenue", detail: "Driven by frictionless funnel and automated expansion" },
  { value: "<0.05", valueSize: "text-2xl", label: "Tickets per user weekly", detail: "Self-service eliminated operational drag" }
]} />
